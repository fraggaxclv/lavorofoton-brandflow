      ...
      <section className="py-16 md:py-24 bg-[hsl(213,50%,8%)] text-white">
        <div className="container-lavoro text-center">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-4">
            {[
              { icon: <img src={iconeFotonGlobal} alt="Foton Global" className="w-10 h-10 object-contain" />, text: "Presente em mais de 110 países" },
              ...
              { icon: <img src={iconeDaimlerBenz} alt="Daimler Benz" className="w-10 h-10 object-contain" />, text: "Joint Venture com a Mercedes-Benz (Daimler) para engenharia de veículos pesados" },

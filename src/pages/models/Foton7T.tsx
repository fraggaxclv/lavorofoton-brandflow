...
const Foton7T = () => {
  ...
  const productImages = [
    {
      src: foton7t,
      alt: "Foton Aumark 715 - Vista Externa",
      caption: "Foto ilustrativa do 715 (exterior)"
    },
    {
      src: foton7t,
      alt: "Foton Aumark 715 - Vista Lateral",
      caption: "Foto ilustrativa do 715 (lateral)"
    },
    {
      src: foton7t,
      alt: "Foton Aumark 715 - Interior da Cabine",
      caption: "Foto ilustrativa do 715 (interior)"
    },
    {
      src: foton7t,
      alt: "Foton Aumark 715 - Chassi",
      caption: "Chassi reforçado do 715"
    },
    {
      src: foton7t,
      alt: "Motor Cummins do Foton Aumark 715",
      caption: "Motor Cummins F2.5"
    }
  ];

  const whatsappNumber = "5531211647335";
  const whatsappMessage = encodeURIComponent("Olá! Gostaria de saber mais sobre o Foton Aumark 715.");
      ...
      <section className="py-16 md:py-24 bg-background">
        <div className="container mx-auto px-4">
          <h2 className="text-3xl md:text-5xl font-bold text-center mb-16 md:mb-20 text-foreground">
            Principais motivos para escolher o <span className="text-primary">715</span>
          </h2>
          ...
          <div className="max-w-6xl mx-auto grid grid-cols-2 md:grid-cols-4 gap-6 md:gap-8 mb-16">
            ...
            <div className="group bg-card border border-border rounded-2xl p-6 md:p-8 hover:shadow-lg hover:border-primary/30 transition-all duration-300 flex flex-col items-center text-center">
              ...
              <p className="font-semibold text-sm md:text-base text-foreground">7 toneladas de capacidade</p>
            </div>
            ...
            <div className="group bg-card border border-border rounded-2xl p-6 md:p-8 hover:shadow-lg hover:border-primary/30 transition-all duration-300 flex flex-col items-center text-center">
              ...
              <p className="font-semibold text-sm md:text-base text-foreground">Motor Cummins F2.5</p>
            </div>
          ...
          <div className="max-w-5xl mx-auto grid md:grid-cols-2 gap-8 mt-12">
            ...
            >
              <img 
                src={foton7t} 
                alt="Foton Aumark 715 - Vista Interna da Cabine" 
                className="w-full h-full object-cover"
              />
            </div>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-6 max-w-5xl mx-auto">
            <div className="bg-white p-8 rounded-lg shadow-sm hover:shadow-md transition-shadow">
              ...
              <p className="text-muted-foreground">
                Motor Cummins F2.5, transmissão ZF S5408, componentes Bosch e Dana. Tecnologia mundial na sua operação.
              </p>
            </div>
            ...
            <div className="bg-white p-8 rounded-lg shadow-sm hover:shadow-md transition-shadow">
              ...
              <h3 className="text-xl font-bold mb-3">Capacidade e versatilidade</h3>
              <p className="text-muted-foreground">
                7 toneladas de capacidade. Perfeito para distribuição urbana e rotas regionais.
              </p>
            </div>
          ...
          <div className="grid md:grid-cols-3 gap-6 max-w-6xl mx-auto">
            <div className="space-y-3">
              ...
              >
                <img 
                  src={foton7t} 
                  alt="Foton Aumark 715 - Vista Exterior" 
                  className="w-full h-full object-cover"
                />
              </div>
              <p className="text-sm text-center text-muted-foreground">Foto ilustrativa do 715 (exterior)</p>
            </div>
            ...
            <div className="space-y-3">
              ...
              >
                <img 
                  src={foton7t} 
                  alt="Foton Aumark 715 - Interior" 
                  className="w-full h-full object-cover"
                />
              </div>
              <p className="text-sm text-center text-muted-foreground">Foto ilustrativa do 715 (interior)</p>
            </div>
            ...
            <div className="space-y-3">
              ...
              <p className="text-sm text-center text-muted-foreground">Motor Cummins F2.5</p>
            </div>
          </div>
        </div>
      </section>
          ...
          <div className="max-w-4xl mx-auto">
            <div className="text-center mb-12">
              ...
              <p className="text-lg text-muted-foreground">
                Todas as especificações técnicas do Foton Aumark 715
              </p>
            </div>
              ...
              <AccordionItem value="motor" className="bg-white border border-border rounded-lg px-6 shadow-sm hover:shadow-md transition-shadow">
                ...
                <AccordionContent className="pt-4 space-y-3">
                  <div className="grid md:grid-cols-2 gap-4">
                    ...
                    <div className="flex justify-between py-2 border-b border-border/50">
                      <span className="text-muted-foreground">Potência Líquida Máxima:</span>
                      <span className="font-medium">150 cv @ 2.900 rpm</span>
                    </div>
                    <div className="flex justify-between py-2 border-b border-border/50">
                      <span className="text-muted-foreground">Torque Líquido Máximo:</span>
                ...
                <AccordionContent className="pt-4 space-y-3">
                  <div className="grid md:grid-cols-2 gap-4">
                    ...
                    <div className="flex justify-between py-2 border-b border-border/50">
                      ...
                      <span className="font-medium">Manual à cabos - 5MT</span>
                    </div>
                    <div className="flex justify-between py-2 border-b border-border/50">
                      <span className="text-muted-foreground">Relações de transmissão:</span>
                      <span className="font-medium text-xs">I:5.762 II:2.922 III:1.638 IV:1 V:0.782 Ré:5.149</span>
                    </div>
                    <div className="flex justify-between py-2 border-b border-border/50">
                      <span className="text-muted-foreground">Embreagem:</span>
                      <span className="font-medium">Tipo seco, mola diafragma Ø325mm</span>
                    </div>
                    <div className="flex justify-between py-2 border-b border-border/50">
                      <span className="text-muted-foreground">Eixo Dianteiro:</span>
                      <span className="font-medium">Viga "I" Aço forjado - 2.5 ton</span>
                    </div>
                    <div className="flex justify-between py-2 border-b border-border/50">
                      <span className="text-muted-foreground">Eixo Traseiro:</span>
                      <span className="font-medium">4.5 ton - Relação 5.375</span>
                    </div>
                    <div className="flex justify-between py-2 border-b border-border/50">
                ...
                <AccordionContent className="pt-4 space-y-3">
                  <div className="grid md:grid-cols-2 gap-4">
                    <div className="flex justify-between py-2 border-b border-border/50">
                      ...
                      <span className="font-medium">5.960 mm</span>
                    </div>
                    <div className="flex justify-between py-2 border-b border-border/50">
                      <span className="text-muted-foreground">Largura máx. dianteira:</span>
                      <span className="font-medium">1.945 mm</span>
                    </div>
                    <div className="flex justify-between py-2 border-b border-border/50">
                    ...
                    <div className="flex justify-between py-2 border-b border-border/50">
                      ...
                      <span className="font-medium">2.250 mm</span>
                    </div>
                    <div className="flex justify-between py-2 border-b border-border/50">
                    ...
                    <div className="flex justify-between py-2 border-b border-border/50">
                      ...
                      <span className="font-medium">1.490 mm</span>
                    </div>
                    <div className="flex justify-between py-2 border-b border-border/50">
                      <span className="text-muted-foreground">Distância ao solo:</span>
                      <span className="font-medium">180 mm</span>
                    </div>
                    <div className="flex justify-between py-2 border-b border-border/50">
              ...
              <AccordionItem value="pesos" className="bg-white border border-border rounded-lg px-6 shadow-sm hover:shadow-md transition-shadow">
                ...
                <AccordionContent className="pt-4 space-y-3">
                  <div className="grid md:grid-cols-2 gap-4">
                    ...
                    <div className="flex justify-between py-2 border-b border-border/50">
                      <span className="text-muted-foreground">Eixo traseiro:</span>
                      <span className="font-medium">4.500 kg</span>
                    </div>
                    <div className="flex justify-between py-2 border-b border-border/50">
                      <span className="text-muted-foreground">PBTC (Combinado):</span>
                      <span className="font-medium">9.000 kg</span>
                    </div>
                    <div className="flex justify-between py-2 border-b border-border/50">
                ...
                <AccordionContent className="pt-4 space-y-3">
                  <div className="grid md:grid-cols-2 gap-4">
                    ...
                    <div className="flex justify-between py-2 border-b border-border/50">
                      ...
                      <span className="font-medium text-xs">Molas parabólicas, amortecedores (5+2 lâminas)</span>
                    </div>
                    <div className="flex justify-between py-2 border-b border-border/50">
                    ...
                    <div className="flex justify-between py-2 border-b border-border/50">
                      ...
                      <span className="font-medium">120L Alumínio</span>
                    </div>
                    <div className="flex justify-between py-2 border-b border-border/50">

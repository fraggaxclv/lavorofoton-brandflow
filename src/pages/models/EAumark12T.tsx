...
import { TrendingDown, Zap, Battery, Package, Shield, Truck, Wrench, CheckCircle2, ChevronLeft, ChevronRight, X, Snowflake } from "lucide-react";
...
const EAumark12T = () => {
  ...
  return <div className="min-h-screen">
            ...
            <div className="space-y-8">
              ...
              <div className="grid grid-cols-2 gap-4 py-6 border-y border-white/10">
                <div>
                  ...
                  <p className="text-2xl font-bold text-green-400">135 kW → 260 kW</p>
                </div>
                <div>
                  <p className="text-sm text-gray-400 mb-1">Torque</p>
                  <p className="text-2xl font-bold text-green-400">1.430 → 2.800 N.m</p>
                </div>
                <div>
                  <p className="text-sm text-gray-400 mb-1">Bateria CATL LFP</p>
                  <p className="text-2xl font-bold">162,28 kWh</p>
                </div>
                <div>
                  <p className="text-sm text-gray-400 mb-1">Garantia</p>
                  <p className="text-2xl font-bold">5 anos / 200.000 km</p>
                </div>
              </div>
      ...
      {/* 🟦 SEÇÃO 2 — POR QUE O e-AUMARK 12T? */}
      <section className="section-padding bg-white dark:bg-industrial-dark">
        <div className="container-lavoro">
          <div className="text-center mb-16">
            <h2 className="mb-4">Por que o e-Aumark 12T?</h2>
            <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
              O caminhão elétrico de alta capacidade para operações exigentes
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div className="group p-8 rounded-2xl bg-gradient-to-br from-blue-50 to-cyan-50 dark:from-blue-950/20 dark:to-cyan-950/20 border border-blue-200 dark:border-blue-800/30 hover:shadow-xl transition-all duration-300">
              ...
              <h3 className="text-xl font-bold mb-4 text-center">Máxima potência e torque</h3>
              <ul className="space-y-2 text-muted-foreground">
                <li className="flex items-start gap-2">
                  <CheckCircle2 className="w-5 h-5 text-blue-500 flex-shrink-0 mt-0.5" />
                  <span>260 kW de potência pico (~350 cv)</span>
                </li>
                <li className="flex items-start gap-2">
                  <CheckCircle2 className="w-5 h-5 text-blue-500 flex-shrink-0 mt-0.5" />
                  <span>2.800 N.m de torque máximo</span>
                </li>
              </ul>
            </div>

            {/* Card 3 — Autonomia real de 220 km */}
            <div className="group p-8 rounded-2xl bg-gradient-to-br from-purple-50 to-violet-50 dark:from-purple-950/20 dark:to-violet-950/20 border border-purple-200 dark:border-purple-800/30 hover:shadow-xl transition-all duration-300">
              ...
              <ul className="space-y-2 text-muted-foreground">
                <li className="flex items-start gap-2">
                  ...
                  <span>Bateria de 162,28 kWh CATL LFP</span>
                </li>
                <li className="flex items-start gap-2">
                  <CheckCircle2 className="w-5 h-5 text-purple-500 flex-shrink-0 mt-0.5" />
            ...
            {/* Card 4 — Capacidade profissional 7.150 kg */}
            <div className="group p-8 rounded-2xl bg-gradient-to-br from-orange-50 to-amber-50 dark:from-orange-950/20 dark:to-amber-950/20 border border-orange-200 dark:border-orange-800/30 hover:shadow-xl transition-all duration-300">
              ...
              <h3 className="text-xl font-bold mb-4 text-center">Alta capacidade: 7.150 kg</h3>
              <div className="space-y-3 text-muted-foreground">
                <p className="text-center font-semibold text-foreground">PBT: 11.500 kg</p>
                <p className="text-sm text-center">
                  Perfeito para baú, sider, refrigerado, socorro, tanque D'água, cesto aéreo, gaiola de gás
                </p>
              </div>
            </div>
            ...
            <div className="group p-8 rounded-2xl bg-gradient-to-br from-teal-50 to-cyan-50 dark:from-teal-950/20 dark:to-cyan-950/20 border border-teal-200 dark:border-teal-800/30 hover:shadow-xl transition-all duration-300">
              ...
              <h3 className="text-xl font-bold mb-4 text-center">Segurança premium completa</h3>
              <ul className="space-y-2 text-muted-foreground">
                <li className="flex items-start gap-2">
                  <CheckCircle2 className="w-5 h-5 text-teal-500 flex-shrink-0 mt-0.5" />
                  <span>ABS + EBD + EPB + AEBS + ESP</span>
                </li>
                <li className="flex items-start gap-2">
                  <CheckCircle2 className="w-5 h-5 text-teal-500 flex-shrink-0 mt-0.5" />
                  <span>Sensor de ré e HSA</span>
                </li>
                <li className="flex items-start gap-2">
                  <CheckCircle2 className="w-5 h-5 text-teal-500 flex-shrink-0 mt-0.5" />
                  <span>Farol automático e de neblina</span>
                </li>
              </ul>
            </div>
      ...
      <section className="section-padding bg-industrial-light dark:bg-black">
        <div className="container-lavoro">
          <div className="text-center mb-16">
            <h2 className="mb-4">Conheça o e-Aumark 12T</h2>
          ...
          <div className="grid md:grid-cols-2 gap-8 max-w-5xl mx-auto">
            ...
            <div className="space-y-6 p-8 rounded-2xl bg-industrial-light dark:bg-white/5 border border-border">
              <div>
                ...
                <p className="text-lg font-bold">11.500 kg</p>
              </div>
              <div>
                <h3 className="text-sm font-semibold text-muted-foreground mb-2">CARGA ÚTIL</h3>
                <p className="text-lg font-bold text-green-600 dark:text-green-400">7.150 kg</p>
              </div>
              <div>
                <h3 className="text-sm font-semibold text-muted-foreground mb-2">CONECTOR</h3>
                <p className="text-lg font-bold">CCS2 (AC – max.22kW / DC – max.108kW)</p>
              </div>
              <div>
              ...
              <div>
                ...
                <p className="text-lg font-bold">4.350 kg</p>
              </div>
            </div>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-8 max-w-5xl mx-auto mt-8">
            ...
            <div className="p-8 rounded-2xl bg-gradient-to-br from-blue-50 to-cyan-50 dark:from-blue-950/20 dark:to-cyan-950/20 border border-blue-200 dark:border-blue-800/30">
              ...
              <ul className="space-y-3 text-foreground">
                ...
                <li className="flex items-start gap-2">
                  <CheckCircle2 className="w-5 h-5 text-blue-500 flex-shrink-0 mt-0.5" />
                  <span>Aquecedor para retrovisor</span>
                </li>
                <li className="flex items-start gap-2">
                  <CheckCircle2 className="w-5 h-5 text-blue-500 flex-shrink-0 mt-0.5" />
            ...
            {/* Opcionais */}
            <div className="p-8 rounded-2xl bg-gradient-to-br from-purple-50 to-violet-50 dark:from-purple-950/20 dark:to-violet-950/20 border border-purple-200 dark:border-purple-800/30">
              <h3 className="text-xl font-bold mb-6 text-center text-purple-700 dark:text-purple-400">
                Opcionais
              </h3>
              <ul className="space-y-3 text-foreground">
                <li className="flex items-start gap-2">
                  <CheckCircle2 className="w-5 h-5 text-purple-500 flex-shrink-0 mt-0.5" />
                  <span>MP5 (tela de 7 polegadas)</span>
                </li>
                <li className="flex items-start gap-2">
                  <CheckCircle2 className="w-5 h-5 text-purple-500 flex-shrink-0 mt-0.5" />
            ...
            <div className="overflow-hidden rounded-2xl border border-border shadow-lg">
              <table className="w-full">
                <thead className="bg-primary text-primary-foreground">
                  <tr>
                    <th className="px-6 py-4 text-left font-bold">Carregador - Potência</th>
                ...
                <tbody className="bg-white dark:bg-industrial-dark divide-y divide-border">
                  <tr className="hover:bg-industrial-light dark:hover:bg-white/5 transition-colors">
                    <td className="px-6 py-4 font-medium">AC – 7kW</td>
                    <td className="px-6 py-4">≈ 23 horas</td>
                  </tr>
                  <tr className="hover:bg-industrial-light dark:hover:bg-white/5 transition-colors">
                    <td className="px-6 py-4 font-medium">AC – 11kW</td>
                    <td className="px-6 py-4">≈ 15 horas</td>
                  </tr>
                  <tr className="hover:bg-industrial-light dark:hover:bg-white/5 transition-colors">
                    <td className="px-6 py-4 font-medium">AC – 22kW</td>
                    <td className="px-6 py-4">≈ 7,5 horas</td>
                  </tr>
                  <tr className="hover:bg-industrial-light dark:hover:bg-white/5 transition-colors">
                    <td className="px-6 py-4 font-medium">DC – 30kW</td>
                    <td className="px-6 py-4">≈ 5,5 horas</td>
                  </tr>
                  <tr className="hover:bg-industrial-light dark:hover:bg-white/5 transition-colors">
                    <td className="px-6 py-4 font-medium">DC – 60kW</td>
                    <td className="px-6 py-4">≈ 3 horas</td>
                  </tr>
                  <tr className="hover:bg-industrial-light dark:hover:bg-white/5 transition-colors">
                    <td className="px-6 py-4 font-medium">DC – 90kW</td>
                    <td className="px-6 py-4">≈ 2 horas</td>
                  </tr>
                  <tr className="hover:bg-industrial-light dark:hover:bg-white/5 transition-colors">
                    <td className="px-6 py-4 font-medium">DC – 120kW</td>
      ...
      <section className="section-padding bg-white dark:bg-industrial-dark">
        <div className="container-lavoro">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-muted-foreground">
              Veja quanto você economiza ao escolher o e-Aumark 12T
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-8 max-w-5xl mx-auto">
            ...
            <div className="p-8 rounded-2xl bg-gradient-to-br from-red-50 to-rose-50 dark:from-red-950/20 dark:to-rose-950/20 border-2 border-red-300 dark:border-red-800/50">
              ...
              <ul className="space-y-3 text-foreground">
                ...
                <li className="flex items-start gap-2">
                  <span className="text-red-500 mt-1">✗</span>
                  <span>R$ 3.500 a R$ 6.000/mês em combustível</span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="text-red-500 mt-1">✗</span>
                  <span>Manutenção pesada e cara</span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="text-red-500 mt-1">✗</span>
          ...
          <div className="mt-12 max-w-4xl mx-auto p-8 rounded-2xl bg-gradient-to-r from-primary/10 to-primary/5 border border-primary/20">
            <div className="flex items-start gap-4">
              ...
              <p className="text-lg text-foreground">
                <strong>Em muitas operações, um e-Aumark 12T se paga apenas com a economia mensal
      ...
      <section className="section-padding bg-industrial-light dark:bg-black">
        <div className="container-lavoro">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-muted-foreground">
              Versatilidade para diversos implementos e operações
            </p>
          </div>
      ...
      <section className="section-padding bg-gradient-to-br from-primary via-primary/90 to-primary/80 text-white">
        <div className="container-lavoro text-center">
          ...
          <p className="text-xl md:text-2xl text-white/90 mb-12 max-w-3xl mx-auto">
            Conheça o e-Aumark 12T e descubra como reduzir custos e aumentar eficiência com zero
            emissões
          </p>

        ...
        <div className="container-lavoro">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="rounded-lg overflow-hidden shadow-[var(--shadow-strong)]">
              <img src={fotonHeavy} alt="Foton 9T" className="w-full h-full object-cover" />
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="section-padding bg-industrial-light">
        <div className="container-lavoro">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <div>
              <h3 className="text-xl font-bold mb-4">Vantagens do 9T:</h3>
              <ul className="space-y-3">
                <li className="flex items-start gap-3">
                  <CheckCircle className="w-5 h-5 text-primary flex-shrink-0 mt-1" />
      ...
      <section className="section-padding bg-primary text-primary-foreground">
        <div className="container-lavoro text-center">
          ...
          <p className="text-xl mb-8 max-w-2xl mx-auto opacity-90">
            O Foton 9T é a escolha ideal para operações que exigem mais carga sem perder eficiência.
          </p>

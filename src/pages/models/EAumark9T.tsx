          ...
          <div className="grid md:grid-cols-3 gap-8 max-w-6xl mx-auto">
            ...
            <div className="space-y-6 p-8 rounded-2xl bg-industrial-light dark:bg-white/5 border border-border">
              <div>
                ...
                <p className="text-lg font-bold">Rear e-Axle</p>
              </div>
              <div>
              ...
              <div>
                ...
                <p className="text-lg font-bold">3.360 mm / 3.800 mm</p>
              </div>
              <div>
              ...
              <div>
                ...
                <p className="text-lg font-bold text-green-600 dark:text-green-400">200 km</p>
              </div>
            </div>
            ...
            <div className="space-y-6 p-8 rounded-2xl bg-industrial-light dark:bg-white/5 border border-border">
              ...
              <div>
                ...
                <p className="text-lg font-bold">215/75 R17.5</p>
              </div>
              <div>
                <h3 className="text-sm font-semibold text-muted-foreground mb-2">CONECTOR</h3>
                <p className="text-lg font-bold">Plug-in CCS2 (AC - OBC 22kW / DC)</p>
              </div>
              <div>
            ...
            {/* Coluna 3 - Itens de Série */}
            <div className="space-y-6 p-8 rounded-2xl bg-gradient-to-br from-green-50 to-emerald-50 dark:from-green-950/20 dark:to-emerald-950/20 border border-green-200 dark:border-green-800/30">
              <h3 className="text-lg font-bold text-green-700 dark:text-green-400 text-center mb-4">Itens de Série</h3>
              ...
              <div className="pt-4 border-t border-green-200 dark:border-green-800/30">
                <h4 className="text-sm font-semibold text-muted-foreground mb-2">OPCIONAIS</h4>

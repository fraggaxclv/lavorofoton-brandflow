...
const CONSUMO_ELETRICO_KWH_KM = 0.2326; // ficha técnica Foton Brasil
...
// Input field component — same pattern as CalculadoraROI
function InputField({ 
...
export default function CalculadoraEWonder() {
  ...
  const calc = useMemo(() => {
    ...
    // Combustível/energia mensal isolado
  ...
  return (
    <>
      <Helmet>
        <title>Calculadora ROI Foton eWonder | Simule sua economia | Lavoro Foton MG</title>
        <meta name="description" content="Simule em tempo real quanto você economiza trocando seu VUC diesel para o Foton eWonder elétrico. Combustível, energia e manutenção. Ferramenta exclusiva Lavoro Foton." />
      </Helmet>
      ...
      <div className="min-h-screen bg-[#0A1F3D] text-white" style={{ fontFamily: "'Poppins', sans-serif" }}>
        ...
        <section className="pt-16 pb-10 md:pt-20 md:pb-14 bg-[#0A1F3D]">
          <div className="max-w-5xl mx-auto px-4 md:px-8 text-center">
            <span className="inline-block bg-[#22C55E]/15 text-[#22C55E] text-sm font-bold px-5 py-2 rounded-full mb-6">
              ⚡ Calculadora eWonder — Elétrico vs Diesel
            </span>
            <h1 className="text-3xl md:text-5xl font-bold mb-4 leading-tight">
              Descubra quanto o eWonder <span className="text-[#22C55E]">economiza vs seu VUC diesel</span>
            </h1>
            <p className="text-white/80 text-lg md:text-xl max-w-3xl mx-auto">
              Preencha os dados da sua operação e veja em tempo real a economia mensal, anual e em 3 anos trocando para o Foton eWonder 100% elétrico.
            </p>
          </div>
        </section>

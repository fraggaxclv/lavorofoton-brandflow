...
const WHATSAPP_MSG = encodeURIComponent("Olá, eu vim dos anúncios do Google e quero saber mais sobre os veículos Foton.");
    ...
    <div className="min-h-screen">
      ...
      <section className="relative h-[85vh] md:h-screen flex items-end justify-center overflow-hidden mt-16">
        ...
        <div className="container-lavoro relative z-10 pb-16 md:pb-20 px-6 md:px-4">
          <div className="flex flex-col sm:flex-row gap-4 justify-center animate-fade-in">
            ...
            <a href={WHATSAPP_URL} target="_blank" rel="noopener noreferrer" className="bg-background/10 backdrop-blur-sm text-primary-foreground px-8 py-4 rounded text-lg font-semibold border-2 border-primary-foreground hover:bg-primary-foreground hover:text-foreground transition-all text-center shadow-2xl">
              Falar com Consultor
            </a>
          </div>
        </div>
      ...
      <section className="section-padding bg-background">
        <div className="container-lavoro">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <ModelCard name="Foton 17T" description="Alta capacidade. Para operações pesadas e longas distâncias." image={fotonHeavy} link="/modelos/auman-d-1722" />
          </div>
        </div>
      </section>
      ...
      <section className="section-padding bg-background">
        <div className="container-lavoro">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {[
              { img: lavoro40Years, alt: "40 anos Lavoro", title: "Especialização", desc: "Foco total em caminhões Foton. Conhecimento profundo da linha." },
              { img: parceriaIcon, alt: "Parceria", title: "Atendimento", desc: "Consultoria dedicada. Entendemos sua operação." },
              { img: qualidadeIcon, alt: "Qualidade", title: "Resultados", desc: "Soluções que impactam diretamente seu resultado operacional." },
              { img: atendimentoMineiroIcon, alt: "Atendimento Mineiro", title: "Confiança", desc: "Operação sólida em Minas Gerais. Parceiro de longo prazo." },
            ].map((item, i) => (
      ...
      <section className="section-padding bg-industrial-dark text-primary-foreground">
        <div className="container-lavoro">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8 text-center">
            <div><div className="text-5xl font-bold text-primary mb-2">100+</div><div className="text-lg text-muted-foreground">Caminhões Vendidos</div></div>
            <div><div className="text-5xl font-bold text-primary mb-2">50+</div><div className="text-lg text-muted-foreground">Empresas Atendidas</div></div>
            <div><div className="text-5xl font-bold text-primary mb-2">87%</div><div className="text-lg text-muted-foreground">Satisfação</div></div>
            <div><div className="text-5xl font-bold text-primary mb-2">24/7</div><div className="text-lg text-muted-foreground">Suporte</div></div>
          </div>
        </div>
      </section>
      ...
      <section className="section-padding bg-primary text-primary-foreground">
        <div className="container-lavoro text-center">
          ...
          <a href={WHATSAPP_URL} target="_blank" rel="noopener noreferrer" className="inline-block bg-background text-foreground px-8 py-4 rounded text-lg font-semibold hover:bg-secondary transition-all">
            Solicitar Orçamento
          </a>
        </div>
      </section>

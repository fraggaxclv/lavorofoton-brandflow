          ...
          <div style="background: #f8fafc; padding: 12px 16px; border-radius: 8px; border: 1px solid #e2e8f0;">
            <div style="display: flex; align-items: center; gap: 10px;">
              ...
              <div style="flex: 1;">
                ...
                <p style="font-size: 10px; color: #64748b; line-height: 1.4; margin: 0;">
                  Fundada pela mesma equipe que construiu a renomada Cardiesel/Grupo VDL, referência no setor até 2020. Escolhemos a FOTON pela excelência em qualidade, tecnologia e custo-benefício — valores que sempre guiaram nossa trajetória.
                </p>
